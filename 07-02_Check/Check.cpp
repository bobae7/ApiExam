...
HINSTANCE g_hInst;
LPCSTR lpszClass = (LPCSTR)TEXT("Check");
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT iMessage, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
        ...
        c2 = CreateWindow(TEXT("button"), TEXT("Goog bye Message?"), WS_CHILD | WS_VISIBLE | BS_AUTOCHECKBOX, 20, 50, 160, 25, hWnd, (HMENU)1, g_hInst, NULL);
